      ...
      el.each(function(index){
            ...
            '<div class="modal-dialog" role="document" style="width: 350px">'+
              '<div class="modal-content">'+
                ...
                '<form class="form-material" action="#">'+
                  '<div class="">'+
                    '<label class="mb-0" for="eventName">Appoinment</label>'+
                    '<input class="form-control" placeholder="asasas" name="event-name" type="text">'+
                  '</div>'+
                  '<div class="">'+
                    '<label class="mb-0" >Appoinment Date</label>'+
                    '<input class="form-control" placeholder="DD/MM/YY" type="date">'+
                  '</div>'+
                  '<label class="mb-0" for="eventType">Event Type</label>'+
                  '<select name="event-bg" class="form-control">'+
                    '<option value="danger">Conference</option>'+
                    '<option value="success">Scan</option>'+
                    // '<option value="info">Info</option>'+
                    // '<option value="warning">Warning</option>'+
                    '<option value="primary">Appoinment</option>'+
                    ...
                    // '<option value="grey">Grey</option>'+
                    // '<option value="indigo">Indigo</option>'+
                    '<option value="orange">Test</option>'+
                    '<option value="yellow">Laboratory</option>'+
                    // '<option value="persian-blue">Persian Blue</option>'+
                    // '<option value="cerize-red">Cerize Red</option>'+
                    // '<option value="mustard">Mustard</option>'+
                  '</select>'+
        ...
        var eventAddModal =
          '<div class="modal fade" id="eventAddModal" tabindex="-1" role="dialog">'+
            '<div class="modal-dialog" role="document" style="width: 350px;border-radius: 8px;">'+
              '<div class="modal-content">'+
                '<div class="modal-header bg-primary">'+
                  '<h4 class="modal-title text-white text-center">Schedule</h4>'+
                '</div>'+
                '<div class="modal-body">'+
                '<form class="form-material" action="#">'+
                  '<div class="">'+
